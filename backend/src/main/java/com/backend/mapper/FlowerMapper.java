...
public interface FlowerMapper {
    ...
    @Update("UPDATE flower SET name = #{name}, description = #{description}, original_price = #{originalPrice}, discount_price = #{discountPrice}, is_on_sale = #{isOnSale}, updated_at = NOW() WHERE flower_id = #{flowerId}")
